...
// Funciton to print current signal strength on lcd
...
//                  Serial.println(Text);
 ...
 //Check if 'NO CARRIER' is printed on Serial monitor
...
// A Funciton to check the length of number calling should be 10 + ('+91' country code) =13
